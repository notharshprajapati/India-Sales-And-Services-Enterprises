...
export const ProductsData = [
  ...
  { img: asset3, name: "Controllers" },
  { img: asset4, name: "Spare Parts for Forklift" },
  { img: asset5, name: "Gears" },
  { img: asset6, name: "Rubber Tyres and Rims" },
  { img: asset7, name: "Hydraulic Cylinders" },
  { img: asset8, name: "Drive Motors" },
  { img: asset9, name: "Polyurethane Wheels" },
  { img: asset10, name: "Brake Parts" },
  { img: asset11, name: "Safety Accessories for Forklifts" },
];
